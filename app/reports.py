...
## This queries the database for the monthly flow of a single (flow) account
## and plots it into a Highcharts graph

def single_account(chartID = 'chart_ID', chart_height = 350):
