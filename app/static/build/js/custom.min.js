    ...
    $SIDEBAR_MENU.find("a").on("click", function(b) {
        ...
        $MENU_TOGGLE.on("click", function() {
            $BODY.hasClass("nav-md") ? ($SIDEBAR_MENU.find("li.active ul").hide(),
                    ...
                    $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), $BODY.toggleClass("nav-md nav-sm"),
                a()
        }),
        $SIDEBAR_MENU.find('a[href="' + CURRENT_URL + '"]').parent("li").addClass("current-page"),
        $SIDEBAR_MENU.find("a").filter(function() { return this.href == CURRENT_URL }).parent("li").addClass("current-page").parents("ul").slideDown(function() { a() }).parent().addClass("active"),
...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [
                ...
                f = 0; f < 30; f++) d.push([new Date(Date.today().add(f).days()).getTime(),
            randNum() + f + f + 10
        ]);
